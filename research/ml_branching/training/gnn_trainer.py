...
from research.ml_branching.runtime.graph import (
...
from research.ml_branching.runtime.checkpoints import GNN_CHECKPOINT_VERSION
from research.ml_branching.training.losses import (
...
class GNNTrainingConfig:
    ...
    report_dir: str = "research/ml_branching/reports"
