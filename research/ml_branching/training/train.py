...
from research.ml_branching.training import load_training_config, run_training_grid


def parse_args(argv: list[str] | None = None):
    parser = argparse.ArgumentParser(description="Train a learned MLP branching scorer.")
    parser.add_argument("--config", default="research/ml_branching/configs/train_mlp.json")
