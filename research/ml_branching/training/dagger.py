...
from research.ml_branching.training.data.collector import collect_instance_samples
...
def main(argv: list[str] | None = None) -> dict:
    ...
    parser.add_argument("--dataset", default="research/ml_branching/data/generated/unit_commitment_round0")
