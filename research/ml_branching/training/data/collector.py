...
from research.ml_branching.training.data.schema import save_sample
from research.ml_branching.families import FAMILY_REGISTRY, FamilyInstance, get_family
from research.ml_branching.training.oracle.strong_branching import StrongBranchingPolicy, make_strong_branch_child_bounds
...
DEFAULT_CONFIG = {
    ...
    "output_dir": "research/ml_branching/data/generated/smoke",
...
def parse_args(argv: list[str] | None = None):
    ...
    parser.add_argument("--config", default="research/ml_branching/configs/smoke.json")
