...
from research.ml_branching.families import get_family
...
from research.ml_branching.training.gnn_trainer import GNNTrainingConfig, train_gnn_one_config
...
def write_report(config: dict) -> Path:
    ...
    lines.extend(
        [
            ...
            "## 8. 当前有效文件结构",
            "",
            "- 配置：`research/ml_branching/configs/stability_train.json`，`research/ml_branching/configs/stability_test.json`",
            ...
            "- 图表：`research/ml_branching/reports/charts/`",
...
def main(argv: list[str] | None = None):
    ...
    parser.add_argument("--train-config", default="research/ml_branching/configs/stability_train.json")
    parser.add_argument("--test-config", default="research/ml_branching/configs/stability_test.json")
