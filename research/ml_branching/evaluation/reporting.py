...
def generate_report(
    dataset_path: str | Path = "research/ml_branching/data/generated/train",
    model_dir: str | Path = "research/ml_branching/trained_models/learning_branching",
    report_dir: str | Path = "research/ml_branching/reports",
) -> dict:
    ...
    lines.extend(
        [
            ...
            "## 10. 当前文件结构",
            "",
            "- `research/ml_branching/families/`: 多模型族生成与复现实例。",
            "- `research/ml_branching/evaluation/audit_dataset.py`: 候选数量和 strong branching 标签审计。",
            "- `research/ml_branching/evaluation/evaluate_expert.py`: most_fractional 与 strong branching 求解收益对比。",
            "- `research/ml_branching/training/train.py`: 审计通过后训练 MLP，并保留最佳 checkpoint。",
            "- `research/ml_branching/evaluation/evaluate_offline.py`: 多 split 离线评估。",
            "- `research/ml_branching/evaluation/evaluate_solver.py`: 三种自写策略与 Gurobi 对比。",
            "- `research/ml_branching/reports/`: 本轮报告、CSV 与图表。",
            "",
            "## 11. 删除和修改记录",
            "",
            "- 删除旧单候选数据集、旧 checkpoint、旧重复报告和旧 smoke/default 配置。",
            "- 删除旧 `research/ml_branching/data/instance_generator.py`，改为统一 family registry。",
...
def parse_args(argv: list[str] | None = None):
    ...
    parser.add_argument("--dataset", default="research/ml_branching/data/generated/train")
    parser.add_argument("--model-dir", default="research/ml_branching/trained_models/learning_branching")
