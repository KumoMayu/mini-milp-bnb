...
from research.ml_branching.runtime.graph import batch_graph_states, sample_to_bipartite_state
from research.ml_branching.unit_commitment import instance_from_parameters


DATASET = "research/ml_branching/data/generated/unit_commitment_round0"
...
def test_bipartite_gnn_supports_variable_graph_sizes_and_permutation_equivariance():
    ...
    from research.ml_branching.runtime.models import BipartiteGNN, BipartiteGNNConfig
...
def test_soft_target_and_margin_are_finite():
    torch = pytest.importorskip("torch")
    from research.ml_branching.training.losses import expert_margin_weight, soft_cross_entropy, soft_targets_from_expert_scores
...
def test_dagger_uses_only_train_instances():
    from research.ml_branching.training.dagger import train_instance_parameters
...
def test_gnn_checkpoint_loads_and_policy_returns_legal_candidate(tmp_path):
    ...
    from research.ml_branching.runtime.models import BipartiteGNN, BipartiteGNNConfig
    from research.ml_branching.training.gnn_trainer import GNN_CHECKPOINT_VERSION
...
def test_no_invalid_old_report_references():
    ...
    report_dir = __import__("pathlib").Path("research/ml_branching/reports")
