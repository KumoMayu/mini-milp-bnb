...
from research.ml_branching.experiments import unified_solver_comparison as unified
...
def test_generated_csvs_do_not_expose_internal_strategy_or_status_ids():
    for path in [
        Path("research/ml_branching/reports/data/presolve_and_queue_comparison.csv"),
        Path("research/ml_branching/reports/data/branching_comparison.csv"),
        Path("research/ml_branching/reports/data/stability_results.csv"),
        Path("research/ml_branching/reports/data/unified_comparison.csv"),
    ]:
        if not path.exists():
...
def test_completed_objectives_are_consistent_in_generated_csvs():
    path = Path("research/ml_branching/reports/data/unified_comparison.csv")
    if not path.exists():
