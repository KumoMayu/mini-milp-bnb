...
from research.ml_branching.evaluation.audit_dataset import audit_dataset
from research.ml_branching.training.data.collector import collect_dataset
from research.ml_branching.training.data.dataset import BranchingDataset
from research.ml_branching.evaluation.evaluate_solver import _solve_gurobi
from research.ml_branching.families import FAMILY_REGISTRY, get_family, reconstruct_instance
from research.ml_branching.runtime.features import FEATURE_NAMES, FeatureNormalizer, candidate_feature_matrix
...
def test_audit_fail_blocks_training(tmp_path):
    ...
    from research.ml_branching.training.trainer import train_one_config
...
def test_training_checkpoint_and_learned_policy_are_valid(tmp_path):
    pytest.importorskip("scipy")
    pytest.importorskip("torch")
    from research.ml_branching.runtime.inference import LearnedBranchingPolicy
    from research.ml_branching.training.train import main as train_main
