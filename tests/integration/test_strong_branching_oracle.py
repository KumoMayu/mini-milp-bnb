...
from research.ml_branching.training.oracle.strong_branching import StrongBranchingPolicy, make_strong_branch_child_bounds, strong_branch_candidates
...
def test_strong_branching_records_all_candidates_and_tie_break_is_smallest_index(monkeypatch):
    ...
    monkeypatch.setattr(
        "research.ml_branching.training.oracle.strong_branching.strong_branch_candidates",
        lambda *args,**kwargs: [
